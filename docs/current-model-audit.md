...
- Actual PPG is total FPL points divided by completed FPL Gameweeks for that player's team.
- Return Delta is Value Balance divided by completed team FPL Gameweeks.
